...
# -- Create Pull Secret
kubectl create secret generic redhat-operators-pull-secret --from-file=.dockerconfigjson=/home/chadams/.docker/config.json --type=kubernetes.io/dockerconfigjson
